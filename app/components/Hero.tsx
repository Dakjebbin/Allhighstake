...
const slides = [
  {
    ...
    subtitle: "Your Game, Your Odds, Your Victory!",
  },
  {
    image: "/slide1.jpg",
    title: "No Risk All Reward",
    subtitle: "Bet with Confidence. Win with Ease!",
  },
  {
    image: "/slide3.jpg",
    title: "Win Big Play Smart.",
      ...
      <div className="relative h-[30rem] md:h-full lg:h-full w-full">
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-contain bg-red-600 bg-center bg-no-repeat"
              style={{
